...
export const metadata: Metadata = {
  ...
  title: {
    default: "JNJ Fumigation Services | Professional Pest Control & Fumigation",
    template: "%s | JNJ Fumigation Services",
  },
  description:
  ...
  openGraph: {
    ...
    title: "JNJ Fumigation Services | Professional Pest Control & Fumigation",
    description:
